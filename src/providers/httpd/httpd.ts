...
export class HttpdProvider {
  ...
  payProducts(idPayment_, products_, userId_, userName_, finalValue_, isPrePrinted_){
    
    let myData = JSON.stringify({id: this.totemId, idPayment: idPayment_, isPrePrinted: isPrePrinted_,
